...
namespace GenAI.API.Services
{
    public class VideoService : IVideoService
    {
        ...
        public VideoService(IWhisperService whisperService)
        {
            ...
            var ffmpegPath = "C:\\Users\\Lenovo\\source\\repos\\ai\\sandeeppatil-newvision\\ffmpeg-7.1.1-essentials_build\\bin"; // Replace with the actual path to FFmpeg executables
